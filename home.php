...
<header class="container">
    <nav class="navbar navbar-expand-sm bg-light">
        <a class="navbar-brand navbar-left" href="#">
            <img src="assets/img/logo-fpmipa.png" alt="" style="width: 150px; height: 50px;">
        </a>
        <ul class="navbar-nav navbar-right ml-auto" id="nav">
            ...
            <li class="nav-item">
                <a href="dosen.php" class="nav-link">DOSEN</a>
            </li>
            <li class="nav-item">
                                    ...
                                    if ($no % 3 === 0){
                                        ...
                                        <div class="carousel-item">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <div class="card">
                                                        <img class="img-fluid" src = "admin/prestasi/foto_prestasi/<?= $data["foto"]; ?>" width="550">
                                                        <div class="card-body">
                                                            <h4 class="card-title"><?php echo $data["judul"];   ?></h4>
                                                            <p class="card-text"><?php echo substr($data['isi'], 0, 50);?></p>
                                                            <a href="detailberita.php?id=<?php echo htmlspecialchars($data['id']); ?>" class="btn btn-info" role="button">Detail</a>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title"><?php echo $data["judul"];   ?></h4>
                                                    <p class="card-text"><?php echo substr($data['isi'], 0, 50);?></p>
                                                    <a href="detailprestasi.php?id=<?php echo htmlspecialchars($data['id']); ?>" class="btn btn-info" role="button">Detail</a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
