...
<body>
    <div class="wrapper">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql="insert into mhs (nim,nama,jenis_kelamin,tmp_lahir,tgl_lahir,alamat,agama,email,no_hp,nama_ortu,nohp_ortu,jurusan,foto) values
            ('$nim','$nama','$jeniskelamin','$tempatLahir','$tanggalLahir','$alamat','$agama','$email','$no_hp','$nama_ortu','$nohp_ortu','$jurusan','$foto')";
        ...
        <h2>Input Data</h2>
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-form-label-lg">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="Masukan nim" required />
                </div>
                ...
                <div class="form-group col-form-label-lg">
                    ...
                    <input type="text" name="no_hp" class="form-control" placeholder="Masukan No HP" pattern="{0-9}+" required/>
                </div>
                <div class="form-group col-form-label-lg">
                ...
                <div class="form-group col-form-label-lg">
                    ...
                    <input type="text" name="nohp_ortu" class="form-control" placeholder="Masukan No HP Orang Tua / Wali" pattern="{0-9}+" required/>
                </div>
