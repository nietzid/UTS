    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="../prestasi/index.php">Data Prestasi</a>
                </li>
            </ul>
        </nav>
        ...
        function upload(){
            ...
            move_uploaded_file($tmpName,'foto_berita/'. $namaFileBaru);
            return $namaFileBaru;
        }
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-form-label-lg">
                    ...
                    <textarea name="isi" class="form-control" rows="5" placeholder="Masukan Alamat" required><?=$data['isi'];?></textarea>
                </div>
        
                <div class="form-group col-form-label-lg">
                    <label for="">Upload Foto</label>
                    <p><img src = "foto_berita/<?= $data["foto"]; ?>" width="150"></p>
